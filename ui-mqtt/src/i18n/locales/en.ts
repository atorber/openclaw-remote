...
export const en: TranslationMap = {
  ...
  mqtt: {
    ...
    noGateways: "No gateways yet. Generate or add one above.",
    addGatewayPlaceholder: "Enter existing Gateway ID and Secret Key",
    confirmAdd: "Add",
    actions: "Actions",
    view: "View",
