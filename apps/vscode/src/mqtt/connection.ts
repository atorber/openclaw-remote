/**
 * MQTT client lifecycle in extension host (Node); uses @atorber/mqtt-core.
 */
...
export function createClient(settings: Settings, callbacks: ConnectionCallbacks): MqttGatewayClient {
  stopClient();
